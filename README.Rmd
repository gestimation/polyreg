...
(3) The model for obtaining inverse probability weights to adjust for censoring is specified by strata. If a stratified variable is specified, dependent censoring is taken into account by the stratified Kaplan-Meier estimator, otherwise weights based on the Kaplan-Meier estimator are calculated. 
