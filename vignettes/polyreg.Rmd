...
Usage of polyreg is illustrated using diabetes.complications dataset included in R-package. Direct polynomial regression is applied to this dataset to estimate risk ratios of the first quartile of fruit intake (fruitq1=1 indicates the first quartile, fruitq1=0 indicates the third to fourth quartile) on diabetes complications (diabetic retinopathy coded by epsilon=1 and macrovascular complications coded by epsilon=2). 
